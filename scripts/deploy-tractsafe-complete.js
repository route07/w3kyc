...
async function main() {
  ...
  try {
    ...
    // 3. Deploy storage contracts first (needed by ComplianceChecker)
    ...
    // 4. Deploy ComplianceChecker with storage addresses
    ...
    // 9. Deploy KYCManager with all dependencies
