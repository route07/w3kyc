...
async function main() {
  console.log("🚀 Starting Tractsafe working contracts deployment...");
  ...
  try {
    ...
    // Write to file
    const deploymentFile = path.join(__dirname, '..', 'deployments', 'tractsafe-working-deployment.json');
    ...
    console.log("\n🎉 Working contracts deployed successfully to Tractsafe network!");
