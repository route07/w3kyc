...
async function main() {
  console.log("🚀 Starting Tractsafe final working deployment...");
  ...
  try {
    ...
    // 6. MultisigManager (no constructor args)
    ...
    // Write to file
    const deploymentFile = path.join(__dirname, '..', 'deployments', 'tractsafe-final-working-deployment.json');
    ...
    console.log("\n🎉 Final working contracts deployed successfully to Tractsafe network!");
