...
export const mockKYCSubmissions: MockKYCSubmission[] = [
  {
    ...
    documents: [
      {
        id: 'doc-001',
        name: 'US_Passport_Web3_Ventures.pdf',
        type: 'passport',
      ...
      {
        id: 'doc-002',
        name: 'Utility_Bill_Web3_Ventures.pdf',
        type: 'utility_bill',
    ...
    sourceOfFunds: 'Business operations and investment returns',
    bankDetails: {
      bankName: 'Chase Bank',
      accountNumber: '****1234',
  ...
  
  {
    ...
    documents: [
      {
        id: 'doc-003',
        name: 'US_Passport_Crypto_Finance.pdf',
        type: 'passport',
      ...
      {
        id: 'doc-004',
        name: 'CryptoFinance_Articles_of_Incorporation.pdf',
      ...
      {
        id: 'doc-005',
        name: 'CryptoFinance_Bank_Statement.pdf',
        type: 'bank_statement',
    ...
    sourceOfFunds: 'Cryptocurrency trading and investment portfolio',
    connectedParties: [
      {
        id: 'cp-002',
        name: 'Web3 Ventures LLC',
