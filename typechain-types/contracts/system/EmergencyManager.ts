...
export interface EmergencyManagerInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "allowedEmergencyFunctions",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setAllowedEmergencyFunction",
...
export interface EmergencyManager extends BaseContract {
  ...
  allowedEmergencyFunctions: TypedContractMethod<
    [arg0: string],
    [boolean],
    "view"
  >;
  ...
  setAllowedEmergencyFunction: TypedContractMethod<
    [functionName: string, allowed: boolean],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "allowedEmergencyFunctions"
  ...
  getFunction(
    nameOrSignature: "setAllowedEmergencyFunction"
  ): TypedContractMethod<
    [functionName: string, allowed: boolean],
    [void],
    "nonpayable"
